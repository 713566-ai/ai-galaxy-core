class AdaptiveIntelligenceV70 {
    ...
    learn(prev, current, rules) {
        ...
        if (this.learnCount % 10 === 0) {
            console.log(`🧬 V70 | R:${reward.toFixed(2)} Avg:${this.avgReward.toFixed(2)} MR:${this.policy.mutationRate.toFixed(3)} Pool:${this.bestPool.length}`);
        }
...
module.exports = AdaptiveIntelligenceV70;
