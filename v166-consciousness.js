...
if(world.memory.length > 5){
  world.memory.shift();
}

// 📈 LEARNING EFFECT
let avgEnergy = world.memory.reduce((a,b)=>a+b.energy,0)/world.memory.length;
world.energy += (avgEnergy - world.energy) * 0.05;

// 🎭 PERSONALITY STABILIZATION
world.desireToSurvive += (0.5 - world.desireToSurvive) * 0.01;
world.greed += (0.5 - world.greed) * 0.01;
world.cooperation += (0.5 - world.cooperation) * 0.01;
